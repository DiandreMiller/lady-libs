      ...
      <div className="mx-auto max-w-3xl rounded-3xl bg-purple-950/70 backdrop-blur-md border border-purple-700/40 shadow-xl shadow-purple-950/70 p-8 sm:p-12">
        ...
        <div className="mb-10 flex justify-center">
          <figure className="relative max-w-sm">
            {/* soft glow */}
            <div
              className="pointer-events-none absolute inset-0 rounded-3xl bg-emerald-400/20 blur-3xl"
              aria-hidden="true"
            />
            <img
              src={LadyLibsPrivacy}
              alt="Lady Libs privacy illustration representing care and discretion"
              className="
              ...
              "
            />
            <figcaption className="mt-3 text-center text-xs text-yellow-100/70">
              Your privacy is handled with care and intention.
            </figcaption>
          </figure>
        </div>
        ...
        <section className="space-y-6 text-sm sm:text-base text-yellow-100/85 leading-relaxed">
          ...
          <p>
            ...
            personal information. This Privacy Policy explains how data is
          ...
          <div>
            ...
            <ul className="list-disc list-inside mt-2 space-y-1">
              ...
              <li>Improve the Lady Libs browsing experience</li>
            </ul>
            <p className="mt-2">
          ...
          <div>
            ...
            <p>
              ...
              form services. Messages may be stored for support and record-keeping
          ...
          <div>
            ...
            <p>
              This site may use minimal analytics tools to understand performance
              and improve usability. No personally identifiable information is
          ...
          <div>
            ...
            <p>
              ...
              is handled, please reach out using the contact form on the site.
            </p>
          </div>
