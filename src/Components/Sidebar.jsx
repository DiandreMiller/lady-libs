      ...
      <div className="flex-1 overflow-y-auto px-5 py-5 space-y-7">
        ...
        >
          <div className="space-y-1 text-sm pl-1">
            ...
            <Link to='/inventory/sweaters'><SidebarMiniLink label="Sweaters" /></Link>

            <SectionLabel className="mt-3">Accessories</SectionLabel>
            <Link to='/inventory/jewlery'><SidebarMiniLink label="Jewelry" /></Link>
            <Link to='/inventory/bags'><SidebarMiniLink label="Bags" /></Link>
            <Link to='/inventory/scarves'><SidebarMiniLink label="Scarves" /></Link>
            <Link to='/inventory/hats'><SidebarMiniLink label="Hats" /></Link>
            ...
            <Link to='/inventory/mirrors'><SidebarMiniLink label="Mirrors" /></Link>
            <Link to='/inventory/wallart'><SidebarMiniLink label="Wall Art" /></Link>
          </div>
        </SidebarSection>
